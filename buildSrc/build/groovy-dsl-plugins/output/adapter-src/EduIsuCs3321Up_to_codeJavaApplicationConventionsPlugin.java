...
/**
 * Precompiled edu.isu.cs3321.Up_to_Code.java-application-conventions script plugin.
 **/
public class EduIsuCs3321Up_to_codeJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduIsuCs3321Up_to_codeJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("edu.isu.cs3321.Up_to_Code.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduIsuCs3321Up_to_codeJavaApplicationConventions").asSubclass(BasicScript.class);
