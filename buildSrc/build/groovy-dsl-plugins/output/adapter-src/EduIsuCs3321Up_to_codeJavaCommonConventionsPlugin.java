...
/**
 * Precompiled edu.isu.cs3321.Up_to_Code.java-common-conventions script plugin.
 **/
public class EduIsuCs3321Up_to_codeJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduIsuCs3321Up_to_codeJavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduIsuCs3321Up_to_codeJavaCommonConventions").asSubclass(BasicScript.class);
